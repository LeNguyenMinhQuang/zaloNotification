...
//                 {
//                     db.SVN_Messages.Add(new SVN_Messages
//                     {
//                         operation = "Checklist",
    ...
    public class DailyApiFetcherJob : IJob
    {
        ...
        public async Task Execute(IJobExecutionContext context)
        {
            ...
            try
            {
                ...
                // foreach (var dept in new[] { 1,2,3,5})
                // {
                //     db.SVN_Messages.Add(new SVN_Messages
                //     {
                //         operation         = "Checklist",
                ...
                //         to_department     = dept,
                //         UserId            = "",
                //         isSent            = 1, // coi như đã gửi
                //         isSentToSupervisor= 1, // theo yêu cầu test
                //         isSentToManager   = 1  // theo yêu cầu test
                //         // KHÔNG preset các cờ is*Seen
                //     });
                // }
                await db.SaveChangesAsync();
